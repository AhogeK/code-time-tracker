...
> 记录关键技术与业务决策（时间线层）。领域专属的**当前有效结论**在 `memory-bank/domains/`（R29），此处保留决策的过程与理由。

## 索引

| 编号 | 标题 | 日期 | 状态 |
|---|---|---|---|
| Decision-001 | TimeTrackerService.onActivity() 竞态条件修复 | 2026-02-19 | 已实施 |
| Decision-002 | DatabaseManager 线程安全性确认 | 2026-02-19 | 已实施（确认安全，仅小修复） |
| Decision-003 | DatabaseManager 重构为 Facade 模式 | 2026-02-26 | 已实施 |
| Decision-004 | StatusBar 时间显示逻辑修复 | 2026-03-17 | 已实施 |
